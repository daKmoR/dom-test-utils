import { Attribute, DefaultTreeNode, DefaultTreeElement, DefaultTreeParentNode, DefaultTreeDocumentFragment, DefaultTreeTextNode, DefaultTreeCommentNode } from 'parse5-es-module';
