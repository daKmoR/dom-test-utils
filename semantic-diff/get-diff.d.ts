 ...
 */
export declare function semanticDiff(leftHTML: string, rightHTML: string): DiffResult | undefined;
/**
 ...
 * @param rightHTML the right HTML tree
 */
export declare function assertEquals(leftHTML: string, rightHTML: string): void;
export {};
